...
#the following scripts will be executed using source(): I'm keeping this code
#here, even though the code for each sourced file is replicated and cleaned up below. It
#seems useful to have if we want to run these chunks in their original files to
#check our code against the original.
...
```{r}
# from "face_summary_pnas.r"

#Author gives summary statistics for each face in confederate sample and
#comparison sample, make comparisons 
